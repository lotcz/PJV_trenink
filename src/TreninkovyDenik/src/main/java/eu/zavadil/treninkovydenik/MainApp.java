...
public class MainApp extends Application {
    ...
    public static Image getIcon() {
        if (icon == null) {
            icon = new Image(MainApp.class.getResourceAsStream( "/images/icon.png" ));
        }
        return icon;
    }
    ...
    public void start(Stage stage) throws Exception {
        ...
        /* check db connection */
        try {
            Connection connection = DriverManager.getConnection(dbconf.get("javax.persistence.jdbc.url"), 
