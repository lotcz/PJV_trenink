...
import eu.zavadil.treninkovydenik.Helpers;
import eu.zavadil.treninkovydenik.MainApp;
...
public class EditExerciseDialog {
    ...
    public EditExerciseDialog(Window owner, Exercise e) {
        ...
        TypedQuery<ExerciseType> q = MainApp.getEntityManager().createQuery("SELECT c FROM ExerciseType c ORDER BY c.name", ExerciseType.class);
        ...
        TypedQuery<Weight> q2 = MainApp.getEntityManager().createQuery("SELECT c FROM Weight c ORDER BY c.weight", Weight.class);
